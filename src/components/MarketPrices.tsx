...
export default function MarketPrices({ language, userDistrict }: MarketPricesProps) {
  ...
  const t = {
    English: {
      ...
      subtitle: "Official daily market rates across major Tamil Nadu agricultural yards. Track historic trends and preview AI price forecast models.",
      ...
      aiPrediction: "Uzhavan AI Price Prediction",
    ...
    Tamil: {
      ...
      subtitle: "தமிழ்நாட்டின் முக்கிய சந்தைகளில் தினசரி பயிர் விலைகள் (eNAM/அக்மார்க்நெட்). வரலாற்றுப் போக்குகள் மற்றும் AI விலை கணிப்புகள்.",
      ...
      aiPrediction: "உழவன் AI விலை கணிப்பு",
